...
from boop.capturer import get_video_frame
from boop.utilities import resolve_relative_path, conditional_download
...
def get_face_analyser() -> Any:
    ...
    with THREAD_LOCK_ANALYSER:
        if FACE_ANALYSER is None or boop.globals.g_current_face_analysis != boop.globals.g_desired_face_analysis:
            model_path = resolve_relative_path('..')
            # removed genderage
            allowed_modules = boop.globals.g_desired_face_analysis
            boop.globals.g_current_face_analysis = boop.globals.g_desired_face_analysis
            if boop.globals.CFG.force_cpu:
                ...
                FACE_ANALYSER = insightface.app.FaceAnalysis(
                    name="buffalo_l", root=model_path, providers=boop.globals.execution_providers,allowed_modules=allowed_modules
                )
            FACE_ANALYSER.prepare(
                ctx_id=0,
                det_size=(640, 640) if boop.globals.default_det_size else (320, 320),
            )
