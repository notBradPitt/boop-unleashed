...
from boop.typing import Face, Frame
...
class FaceSwapInsightFace():
    ...
    def Initialize(self, plugin_options:dict):
        ...
        if self.model_swap_insightface is None:
            ...
            self.model_swap_insightface = onnxruntime.InferenceSession(model_path, sess_options, providers=boop.globals.execution_providers)
