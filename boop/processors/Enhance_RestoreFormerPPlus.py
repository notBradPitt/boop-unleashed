...
from boop.typing import Face, Frame, FaceSet
from boop.utilities import resolve_relative_path
...
class Enhance_RestoreFormerPPlus():
    ...
    def Initialize(self, plugin_options:dict):
        ...
        if self.model_restoreformerpplus is None:
            ...
            self.model_restoreformerpplus = onnxruntime.InferenceSession(model_path, None, providers=boop.globals.execution_providers)
